...
class ServerAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ["Basic Info", {"fields": ["id", "name"]}],
        ["Related Objects", {"fields": ["owner"]}],
        ["Dates", {"fields": ["created_at"]}],
        ["Icon", {"fields": ["icon"]}],
        ["State Flags", {"fields": ["is_deleted"]}],
    ]
...
class ServerInviteAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ["Basic Info", {"fields": ["id", "code"]}],
        ["Related Objects", {"fields": ["inviter", "server"]}],
        ["Dates", {"fields": ["created_at", "expires_at"]}],
        ["Uses", {"fields": ["uses", "max_uses"]}],
        ["State Flags", {"fields": ["is_deleted", "is_expired"]}],
    ]
...
class ServerAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ["Basic Info", {"fields": ["id"]}],
        ["Related Objects", {"fields": ["user", "server"]}],
